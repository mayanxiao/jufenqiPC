...
<div v-if="show" class="vue-preload-image">
  <div class="progress">
    <slot></slot>
    <div v-if="animationShow" class="loadingAnimation"></div>
    <div class="flex-wp">
      <p v-if="tipStrShow" class="tip-str">{{tipStr}}</p>
      <p v-if="progressShow" class="progress-str">{{progressStr}}</p>
    </div>
  </div>
</div>
